...
class Ride(Base):
    ...
    distance_fare: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    time_fare: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    service_fee: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    booking_fee: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    discount: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    surge_multiplier: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
