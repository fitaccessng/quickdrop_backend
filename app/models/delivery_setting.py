...
class DeliverySetting(Base):
    ...
    per_km: Mapped[float] = mapped_column(Float, default=0)
    per_minute: Mapped[float] = mapped_column(Float, default=0)
    minimum_fare: Mapped[float] = mapped_column(Float, default=0)
    service_fee: Mapped[float] = mapped_column(Float, default=0)
    booking_fee: Mapped[float] = mapped_column(Float, default=0)
    surge_multiplier: Mapped[float] = mapped_column(Float, default=1)
    priority_surcharge: Mapped[float] = mapped_column(Float, default=0)
